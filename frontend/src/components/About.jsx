    ...
    <section id="about" className="py-20 px-6 bg-gray-950 text-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-300 leading-relaxed">
          Je m'appelle Youssef, développeur Full-Stack passionné basé en France 🇫🇷. J'adore créer des interfaces modernes, fluides et accessibles avec React, Tailwind CSS et les dernières technologies du web.
        </p>
